...
pub fn handle<S: Storage, A: Api, Q: Querier>(
    ...
    env: Env,
    msg: HandleMsg,
) -> StdResult<HandleResponse<CosmixSDK>> {
    match msg {
        HandleMsg::AssetMint {
            classificationID,
...
impl Into<CosmosMsg<CosmixSDK>> for CosmixSDK {
    fn into(self) -> CosmosMsg<CosmixSDK> {
